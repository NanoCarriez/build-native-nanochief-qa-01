...
const OG_SKILL_PATH = join(TEMPLATE_ROOT, ".grok/skills/og/SKILL.md");
const HAS_OG_SKILL = existsSync(OG_SKILL_PATH);
...
test("SKILL.md and AGENTS.md name the marker path and bound this script uses", { skip: !HAS_OG_SKILL }, () => {
...
test("the sections that own the brand-task prohibition never affirm a wait", { skip: !HAS_OG_SKILL }, () => {
